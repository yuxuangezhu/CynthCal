...
enum AppUpdater {
  private enum Constants {
    static let endpoint = "https://api.github.com/repos/yuxuangezhu/CynthCal/releases/latest"
    static let decoder = {
...
private extension AppUpdater {
  static func presentError() {
    ...
    NSWorkspace.shared.safelyOpenURL(string: "https://github.com/yuxuangezhu/CynthCal/releases")
  }
...
private extension Localized {
  enum Updater {
    ...
    static let upToDateMessageFormat = String(localized: "CynthCal %@ is currently the latest version.", comment: "Message for the up-to-date info")
    static let newVersionAvailableTitle = String(localized: "CynthCal %@ is available!", comment: "Title for new version available")
