...
enum Localized {
  ...
  enum UI {
    ...
    static let menuTitleCustomFontSize = String(localized: "Custom Font Size…", comment: "[Menu] Configure the font size of the custom text icon")
    ...
    static let menuTitleFirstWeekday = String(localized: "First Weekday", comment: "[Menu] Section title for the first weekday")
    static let menuTitleFirstWeekdaySystem = String(localized: "System", comment: "[Menu] Follow the system first weekday")
    static let menuTitleFirstWeekdaySunday = String(localized: "Sunday", comment: "[Menu] Start the week on Sunday")
    static let menuTitleFirstWeekdayMonday = String(localized: "Monday", comment: "[Menu] Start the week on Monday")
    ...
    static let menuTitleAnniversaries = String(localized: "Anniversaries", comment: "[Menu] Personal lunar anniversaries")
    static let menuTitleShowAnniversaries = String(localized: "Show Anniversaries", comment: "[Menu] Show anniversary markers on the grid")
    static let menuTitleManageAnniversaries = String(localized: "Manage Anniversaries…", comment: "[Menu] Open the anniversaries management window")
    ...
    static let menuTitleAboutCynthCal = String(localized: "About CynthCal", comment: "[Menu] Open the standard about panel")
    static let menuTitleGitHub = String(localized: "GitHub", comment: "[Menu] Open the CynthCal repository on GitHub")
    static let menuTitleCheckForUpdates = String(localized: "Check for Updates…", comment: "[Menu] Check for new versions")
    static let menuTitleQuitCynthCal = String(localized: "Quit CynthCal", comment: "[Menu] Quit the app")

    // Anniversary window
    static let messageNoAnniversaries = String(localized: "No anniversaries yet. Click + to add one.", comment: "[Anniversary] Empty state message")
    static let buttonEdit = String(localized: "Edit", comment: "[Anniversary] Edit button")
    static let buttonAdd = String(localized: "Add", comment: "[Anniversary] Add button")
    static let buttonSave = String(localized: "Save", comment: "[Anniversary] Save button")
    static let placeholderAnniversaryName = String(localized: "Name, e.g. Mom's Birthday", comment: "[Anniversary] Name field placeholder")
    static let labelMonth = String(localized: "Month", comment: "[Anniversary] Lunar month picker label")
    static let labelDay = String(localized: "Day", comment: "[Anniversary] Lunar day picker label")
    static let labelCalendarType = String(localized: "Calendar", comment: "[Anniversary] Lunar/Solar calendar segmented control label")
    static let labelLunar = String(localized: "Lunar", comment: "[Anniversary] Lunar calendar option")
    static let labelSolar = String(localized: "Solar", comment: "[Anniversary] Solar (Gregorian) calendar option")
    static let labelLeapMonth = String(localized: "Leap Month", comment: "[Anniversary] Leap month toggle label")
    static let labelRecurring = String(localized: "Repeats every year", comment: "[Anniversary] Recurring toggle label")
    static let labelOneTimeFormat = String(localized: "Lunar year %d", comment: "[Anniversary] One-time anniversary display, e.g. Lunar year 2024")
    ...
    static let alertMessageRelaunchRequired = String(localized: "Relaunch CynthCal to apply the change.", comment: "[Alert] Message about relaunch after changing the interface")
    static let alertMessageSetCustomFontSize = String(localized: "Set Custom Font Size", comment: "[Alert] Configure the font size of the custom text icon")
  ...
  enum Calendar {
    ...
    /// The 12 Earthly Branches, also used for traditional Chinese time periods (时辰).
    /// Always shown in Chinese.
    static let earthlyBranches = [
      String(localized: "EB_01", comment: "The 1st Earthly Branch, always in Chinese"),
      String(localized: "EB_02", comment: "The 2nd Earthly Branch, always in Chinese"),
      String(localized: "EB_03", comment: "The 3rd Earthly Branch, always in Chinese"),
      String(localized: "EB_04", comment: "The 4th Earthly Branch, always in Chinese"),
      String(localized: "EB_05", comment: "The 5th Earthly Branch, always in Chinese"),
      String(localized: "EB_06", comment: "The 6th Earthly Branch, always in Chinese"),
      String(localized: "EB_07", comment: "The 7th Earthly Branch, always in Chinese"),
      String(localized: "EB_08", comment: "The 8th Earthly Branch, always in Chinese"),
      String(localized: "EB_09", comment: "The 9th Earthly Branch, always in Chinese"),
      String(localized: "EB_10", comment: "The 10th Earthly Branch, always in Chinese"),
      String(localized: "EB_11", comment: "The 11th Earthly Branch, always in Chinese"),
      String(localized: "EB_12", comment: "The 12th Earthly Branch, always in Chinese"),
    ]

    /// The 12 traditional two-hour periods (时辰名), each suffixed with 时.
    static let shichenNames = [
      String(localized: "SCN_01", comment: "The 1st shichen name, always in Chinese"),
      String(localized: "SCN_02", comment: "The 2nd shichen name, always in Chinese"),
      String(localized: "SCN_03", comment: "The 3rd shichen name, always in Chinese"),
      String(localized: "SCN_04", comment: "The 4th shichen name, always in Chinese"),
      String(localized: "SCN_05", comment: "The 5th shichen name, always in Chinese"),
      String(localized: "SCN_06", comment: "The 6th shichen name, always in Chinese"),
      String(localized: "SCN_07", comment: "The 7th shichen name, always in Chinese"),
      String(localized: "SCN_08", comment: "The 8th shichen name, always in Chinese"),
      String(localized: "SCN_09", comment: "The 9th shichen name, always in Chinese"),
      String(localized: "SCN_10", comment: "The 10th shichen name, always in Chinese"),
      String(localized: "SCN_11", comment: "The 11th shichen name, always in Chinese"),
      String(localized: "SCN_12", comment: "The 12th shichen name, always in Chinese"),
    ]
  }
}
