...
class AppDelegate: NSObject, NSApplicationDelegate {
  ...
  func applicationDidFinishLaunching(_ notification: Notification) {
    ...
    // Apply the persisted first weekday override before the calendar is rendered
    WeekdayPreference.shared.firstWeekday = AppPreferences.General.firstWeekday.preferredValue
  ...
  func updateMenuBarIcon(needsLayout: Bool = false) {
    ...
    let accessibilityLabel = AppPreferences.General.menuBarIcon == .custom ? customDateText() : "CynthCal"
